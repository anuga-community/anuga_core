...
# Note: Some test utility functions may not be available in unified extension
try:
    from anuga.shallow_water.sw_domain_ext import flux_function_central as flux_function
except ImportError:
    flux_function = None  # Tests using this will be skipped

# Use Python implementation of rotate from boundaries module
from anuga.shallow_water.boundaries import rotate
